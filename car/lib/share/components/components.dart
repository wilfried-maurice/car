...
import 'package:car/share/components/build_car_list.dart';
...
Padding buildStatCar(IconData icon, String title, String desc, Size size,
        ThemeData themeData) =>
    Padding(
...
// build statbar in card screen
Padding buildInfoCar(IconData icon, String title, String desc, Size size,
        ThemeData themeData) =>
    Padding(
      padding: EdgeInsets.symmetric(horizontal: size.width * 0.015),
      child: DelayedAnimation(
...
Widget buildTopBrands(Size size, ThemeData themeData) => Column(
      children: [
              ...
              child: InkWell(
                onTap: () {
                  Get.to(CardPage(
                    ...
                    localisation: cars[i]['localisation'],
                    adress: cars[i]['adress'],
                    viewCount: cars[i]['viewCount'],
                    phoneNum: cars[i]['phoneNum'],
                  ));
                },
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
